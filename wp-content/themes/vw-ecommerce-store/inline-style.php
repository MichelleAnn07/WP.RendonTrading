<?php
	...
	if($vw_ecommerce_store_first_color != false){
		$vw_ecommerce_store_custom_css .='.wp-block-button .wp-block-button__link:hover{';
			$vw_ecommerce_store_custom_css .='color: '.esc_html($vw_ecommerce_store_first_color).'!important;';
		$vw_ecommerce_store_custom_css .='}';
	}
	if($vw_ecommerce_store_first_color != false){
	...
	if($vw_ecommerce_store_products_padding_top_bottom != false){
		$vw_ecommerce_store_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$vw_ecommerce_store_custom_css .='padding-top: '.esc_html($vw_ecommerce_store_products_padding_top_bottom).'!important; padding-bottom: '.esc_html($vw_ecommerce_store_products_padding_top_bottom).'!important;';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_products_padding_left_right != false){
		$vw_ecommerce_store_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$vw_ecommerce_store_custom_css .='padding-left: '.esc_html($vw_ecommerce_store_products_padding_left_right).'!important; padding-right: '.esc_html($vw_ecommerce_store_products_padding_left_right).'!important;';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_products_box_shadow != false){
		$vw_ecommerce_store_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
				$vw_ecommerce_store_custom_css .='box-shadow: '.esc_html($vw_ecommerce_store_products_box_shadow).'px '.esc_html($vw_ecommerce_store_products_box_shadow).'px '.esc_html($vw_ecommerce_store_products_box_shadow).'px #ddd;';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_products_border_radius != false){
		$vw_ecommerce_store_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$vw_ecommerce_store_custom_css .='border-radius: '.esc_html($vw_ecommerce_store_products_border_radius).'px;';
		$vw_ecommerce_store_custom_css .='}';
	}